 ...
 */
public class Last3ChargesServiceImpl implements Last3ChargesService {
    ...
    public String getCharges(String serviceName, String request) {
        String servicType = bundle.getString("last3Charges");
    ...
    public String addService_1(String serviceName, String request) {
        if (Constant.OUTPUT.equals("SUCCESS")) {
            ...
            return "sci0a" + "|"+Field1+"|"+Field2+"|"+Field3+"|";
        } else return "sci1acc.incorrect|";
    }
