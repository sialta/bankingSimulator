 ...
 */
public class CellphoneChargeWithCardServiceImpl implements CellphoneChargeWithCardService {
    ...
    public String charge(String serviceName, String request) {
        String servicType = bundle.getString("chargeWithCard");
    ...
    public String addService_1(String serviceName, String request) {
        ...
        return "scc0scc.a.card" + "|"+simType+chargeCode+
                PackNumeric.packNumeric(Constant.date+Constant.trace)+PackNumeric.packNumeric2(Constant.chargeSerialNo+Constant.chargePin)+"|"+
                PackNumeric.packNumeric2(Constant.bankPin)+PackNumeric.packNumeric2(cardNumber4digs)+"|";
    } else return "scc1acc.incorrect|";
    }
