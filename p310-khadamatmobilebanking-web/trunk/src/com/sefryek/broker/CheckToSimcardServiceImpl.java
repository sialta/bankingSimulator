 ...
 */
public class CheckToSimcardServiceImpl implements CheckToSimcardService {
    ...
    @Override
    public String moveCheckInfo(String serviceName, String request) {
        String servicType = bundle.getString("checkAmount");
