 ...
 */
public class RemoveOnewayServiceImpl implements RemoveOnewayService {
    ...
    @Override
    public String removeService(String serviceName, String request) {
        String servicType = bundle.getString("removeService");
    ...
    public String addService_1(String serviceName, String request) {
        ...
        String acc = params[2].substring(0,13);
        String Field1="";
        ...
        String Field3 = PackNumeric.packNumeric("12345678912341");
        return "dis0srv.rs" + "~"+Field1+"~"+acc+"~|"+Field3+"|";
    } else return "dis1acc.incorrect|";
    }
